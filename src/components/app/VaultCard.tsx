            ...
            >
                ...
                <div style={{ height: '48px', marginBottom: '20px', opacity: 0.7 }}>
                    <ResponsiveContainer width="100%" height="100%" style={{ outline: 'none' }}>
                        <AreaChart data={chartData} margin={{ top: 0, right: 0, bottom: 0, left: 0 }} style={{ outline: 'none' }}>
                            <defs>
                            ...
                            <Area type="monotone" dataKey="apy" stroke="#00e87a" strokeWidth={1.5} fill={`url(#gradient-${vault.symbol})`} dot={false} isAnimationActive={false} style={{ outline: 'none' }} />
                            <Tooltip
